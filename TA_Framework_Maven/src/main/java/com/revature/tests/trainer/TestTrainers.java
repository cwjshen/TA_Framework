...
public class TestTrainers extends TrainerSuite {
	...
	public void onTrainersTab() { 
		...
		assertTrue(TrainerCukes.isInTrainers(wd));
		assertTrue(TrainerCukes.calendarButtonExists(wd));
		assertTrue(TrainerCukes.downloadResumeButton(wd));
	}
	...
	public void clickCalendarButton() {
		...
		assertTrue(TrainerCukes.isPtoCalendarOpen(wd));
	}
	...
	public void clickAddPtoButton() {
		...
		assertTrue(TrainerCukes.ptoRequestWindowOpen(wd));
	}
