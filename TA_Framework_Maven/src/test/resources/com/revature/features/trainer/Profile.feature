...
Feature: Profile Tab for trainers
  ...
  @tag1
  Scenario Outline: Navigate to Profile tab
  ...
  @tag2
  Scenario Outline: Click the first name text box
  ...
  @tag3
  Scenario Outline: Enter a value into the first name text box
    Given I am on the profile tab 
  ...
  @tag4
  Scenario Outline: Click the last name text box
    Given I am on the profile tab 
  ...
  @tag5
  Scenario Outline: Enter a value into the last name text box
    Given I am on the profile tab 
  ...
  @tag6
  Scenario Outline: Click the Add/Update Resume button
    Given I am on the profile tab 
  ...
  @tag7
  Scenario Outline: Click the Update Resume button
    Given I am on the profile tab 
  ...
  @tag8
  Scenario Outline: Click on a skill to add
    Given I am on the profile tab 
  ...
  @tag9
  Scenario Outline: Click on a current skill to remove
    Given I am on the profile tab 
  ...
  @tag12
  Scenario Outline: Click on the certification name text box
    Given I am on the profile tab 
  ...
  @tag13
  Scenario Outline: Enter a value into the certification name text box
    Given I am on the profile tab 
  ...
  @tag14
  Scenario Outline: Click the Update certification button
    Given I am on the profile tab 
  ...
  @tag15
  Scenario Outline: Click on the remove certifications button
    Given I am on the profile tab 
   ...
   @tag16
    Scenario Outline: Click on a certification
    Given I am on the profile tab 
