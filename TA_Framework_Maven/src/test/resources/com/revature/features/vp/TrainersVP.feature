...
Feature: Trainers Tab for VP
  ...
  @tag1
    Scenario: Check if in Trainers Tab for VP
  ...
  @tag2
    Scenario: Check if the Add trainer button works
  ...
  @tag3
    Scenario: Check if I can enter text into the first name text box in the Add Trainers popup
  ...
  @tag4
    Scenario: Check if I can enter text into the last name text box in the Add Trainers popup
    Given That the add trainer popup window is open <webdriver>
    When I click on the last name text box <webdriver>
    Then I should be able to enter text into the text box <webdriver>

  @tag5
    Scenario: Check if the save button in the add trainers popup adds a new trainer 
    Given That the add trainer popup window is open <webdriver>
  ...
  @tag6
  	Scenario: Checking if the cancel button on the add trainers popup works
  ...
  @tag8
    Scenario: Check if the deactivate trainer button works
    Given That I am in the Trainers tab <webdriver>
  ...
  @tag9
    Scenario: Check if the reactivate trainer button works
    Given That I am in the Trainers tab <webdriver>
  ...
  @tag13
  	Scenario: Checking if the cancel PTO request button on the PTO calendar works
  ...
  @tag14
  	Scenario: Checking if selecting a start date in the PTO request window works
  	Given that the add PTO request popup is open <webdriver>
   ...
   @tag15
  	Scenario: Checking if selecting an end date in the PTO request window works
  	Given that the add PTO request popup is open <webdriver>
  	When I click the end date text box <webdriver>
  	Then A drop down calendar should appear which allows me to select a date <webdriver> 
  	
  @tag16
  	Scenario: Checking if the send button in the PTO request window works
  	Given that the add PTO request popup is open <webdriver>
