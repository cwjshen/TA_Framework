...
Feature: VP Overview Tab
 ...
 @tag1
  ...
  Scenario: Check if CSV downloaded
	...
	@tag3
	Scenario: Click the Name button to sort data ASC/DSC
  ...
  @tag4
	Scenario: Click the Curriculum button to sort data ASC/DSC
	...
	@tag5
	Scenario: Click the Trainer button to sort data ASC/DSC
	...
	@tag6
	Scenario: Click the Location button to sort data ASC/DSC
	...
	@tag7
	Scenario: Click the Building button to sort data ASC/DSC
	...
	@tag8
	Scenario: Click the Room button to sort data ASC/DSC
	...
	@tag9
	Scenario: Click the Start Date button to sort data ASC/DSC
	...
	@tag10
	Scenario: Click the End Date button to sort data ASC/DSC
	...
	@tag11
	Scenario: Click the filter button then click In Progress
